...
// local modules
var escapeRegExp = reqlib('/lib/utils/strings.js').escapeRegExp;
var singularize = reqlib('/lib/utils/strings.js').singularize;
var pluralize = reqlib('/lib/utils/strings.js').pluralize;
var arrayify = reqlib('/lib/utils/strings.js').arrayify;
